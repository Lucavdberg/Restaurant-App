    ...
    public void reserveringFunc(JsonClassTafels tafels, int cijfer)
    {
        ...
        while (true)
        {
            try
            {
                ...
                Console.Write("Vul een datum in:  ");
                datum = Console.ReadLine();
                Console.Write("Vul een tijdstip in:  ");
                tijdstip = Console.ReadLine();
                Console.Write("Vul het aantal personen in:  ");
                do
                {
                    ...
                    {
                        Console.WriteLine("Het ingevoerde getal moet een positief getal zijn en lager dan het maximum aantal zitplaatsen namelijk 50.");
                    }
                } while (newperson <= 0 || newperson > 50);
                
                Console.Write("Vul hier belangrijke details in:  ");
